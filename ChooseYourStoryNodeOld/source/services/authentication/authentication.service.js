...
var AuthenticationService = (function () {
    function AuthenticationService(store, lock, authHttp) {
        this.store = store;
        this.lock = lock;
        this.authHttp = authHttp;
    }
    Object.defineProperty(AuthenticationService.prototype, "profile", {
        get: function () {
    ...
    AuthenticationService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [store_service_1.Store, Lock, angular2_jwt_1.AuthHttp])
